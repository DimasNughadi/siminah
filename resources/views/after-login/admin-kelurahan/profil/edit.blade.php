                        ...
                        <div class="container-fluid body">
                            ...
                            <div class="row">
                                <div class="col-md-4 section-1">
                                    <x-forms.formControlAdmin label="Nama" name="name" placeholder="Nama lengkap" disabled="true" value="{{ $user->nama_admin }}"/>
                                </div>
                                <div class="col-md-4 section-2">
                                    <x-forms.formControlAdmin label="Username" name="username" placeholder="Username" disabled="true" value="{{ $user->username }}"/>
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-4 section-1">
                                    <div class="form-control-admin animate__animated animate__fadeInUp">
                                        ...
                                        <input type="password" class="form-control" id="gantiPassword" placeholder="Ganti password disini"
                                ...
                                <div class="col-md-4 section-2">
                                    <div class="form-control-admin animate__animated animate__fadeInUp">
                                        ...
                                        <input type="password" class="form-control" id="konfirmasiPassword" placeholder="Ketik ulang password disini"
                                        name="konfirmasiPassword" required >
                                        <p class="text-danger" id="PasswordNotMatch"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-md-4 section-1">
                                    <x-forms.formControlAdmin label="No Telepon" name="no_hp"
                                        placeholder="Nomor telepon" disabled="true" value="{{ $user->no_hp }}"/>
                                </div>
                                <div class="col-md-4 section-2">
                                    <x-forms.formControlAdmin label="Email" name="email" placeholder="Email" disabled="true" value="{{ $user->email }}"/>
                                </div>
                                {{-- <div class="col-md-4 section-2">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-4 section-1">
                                    <x-forms.selectOption name="id_lokasi" label="Kelurahan" disabled="true">
                                        @slot('slotOptions')
                                            <option @if ($user->id_lokasi === $user->id_lokasi)
                                                {{ 'selected' }}
                                            @endif value="{{ $user->id_lokasi }}">{{ $user->nama_kelurahan }}</option>
                                        @endslot
                                    </x-forms.selectOption>
                                </div>
                                <div class="col-md-4 section-2">
                                    <x-forms.formControlAdmin label="Alamat" name="alamat_rumah"
                                        placeholder="Alamat tempat tinggal Admin Kelurahan" disabled="true" value="{{ $user->alamat_rumah }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
